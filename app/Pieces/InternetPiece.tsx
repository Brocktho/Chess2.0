...
export const NetPiece = ({initialPosition, pieceClass, color, moves, moveGenerator, id, notifyBoard}:{initialPosition:Coordinates, pieceClass:string, color:number, moves:Array<Coordinates>, moveGenerator:Function, id:string, notifyBoard:Function}
    ) => {
